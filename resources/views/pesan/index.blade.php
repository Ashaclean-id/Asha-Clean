                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 sticky top-8">
                        ...
                        <div class="flex gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-500">{{ $service->duration ?? '-' }} • {{ $service->team_size ?? 1 }} Orang</p>
                            </div>
                        </div>

                        <div class="bg-slate-50 rounded-xl p-4 mb-4">
                            <p class="text-xs font-bold text-slate-500 uppercase mb-3">Detail Layanan:</p>
                            <ul class="space-y-2">
                        ...
                        <div class="space-y-3 text-sm text-slate-600 mb-6">
                            <div class="border-t border-dashed border-slate-200 my-2 pt-2 flex justify-between items-center text-slate-800">
                                ...
                                <span class="font-extrabold text-xl text-blue-600">Rp {{ number_format($totalPrice, 0, ',', '.') }}</span>
                        ...
                        <p class="text-center text-xs text-slate-400 mt-4">Lanjutkan untuk pembayaran via Midtrans.</p>

                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 md:p-8">
                    ...
                    <form action="{{ route('pesan.submit') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="name" class="w-full px-4 py-3 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition" placeholder="Contoh: Budi Santoso" required>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="phone" class="w-full pl-14 pr-4 py-3 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition" placeholder="81234567890" required>
                            </div>
                            <p class="text-[10px] text-slate-400 mt-1">*Kami akan menghubungi nomor ini untuk konfirmasi.</p>
                        </div>

                        <div class="grid grid-cols-2 gap-4 mb-6">
                            <div>
                                <label class="block text-xs font-bold text-slate-700 uppercase mb-2">Tanggal Booking</label>
                                <input type="date" name="booking_date" class="w-full px-4 py-3 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 text-slate-600" required>
                            </div>
                            <div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="address" rows="3" class="w-full px-4 py-3 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition" placeholder="Nama Jalan, Nomor Rumah, RT/RW, Kelurahan, Kecamatan..." required></textarea>
                        </div>

                        <div class="mb-8">
                            <label class="block text-xs font-bold text-slate-700 uppercase mb-2">Catatan Tambahan (Opsional)</label>
                            <textarea name="notes" rows="2" class="w-full px-4 py-3 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition" placeholder="Misal: Pagar warna hitam, ada anjing galak, dll."></textarea>
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 sticky top-8">
                    ...
                    <div class="space-y-3 text-sm text-slate-600 mb-6">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="text-green-600 italic font-medium">Gratis*</span>
                        </div>
                    ...
                    <div class="bg-blue-50 p-4 rounded-xl flex gap-3 items-start">
                        ...
                        <p class="text-xs text-blue-700 leading-relaxed">
                            Pembayaran dilakukan <strong>setelah pengerjaan selesai</strong> (Cash/Transfer). Tim kami akan mengonfirmasi via WhatsApp.
                        </p>
                    </div>

...
class ServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // 2. DAFTAR KOLOM YANG TIDAK BOLEH MASUK LANGSUNG KE DB
        // Kita exclude 'image' dan semua inputan benefit individual
        ...
        // 5. HANDLE JSON BENEFITS
        // Kita ambil manual, bungkus jadi array, lalu masukkan ke kolom 'benefits'
        $benefits = [];
        for ($i = 1; $i <= 4; $i++) {
            $benefits[] = [
        ...
        $data['benefits'] = $benefits; // <--- Masuk ke kolom JSON
